                        ...
                        <div class="shopping-cart-form table-responsive">
                                            ...
                                            <tr class="cart-product-item">
                                                <td class="product-remove">
                                                    <form action="{{ route('cart.delete', $cart->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <!-- Đây là phần quan trọng để gửi yêu cầu DELETE -->
                            ...
                            <td class="product-thumb">
                                <a href="{{ route('cart.show', $cart->variant->product_id) }}" class="cart-item">
                                    <img src="{{ $cart->variant->product->primary_image_url }}" width="90"
                                        height="110" alt="{{ $cart->variant->product->name }}">
                            ...
                            <td class="product-name">
                                <h4 class="title">
                                    <a
                                        href="{{ route('cart.show', $cart->variant->product_id) }}">{{ $cart->variant->name }}</a>
                                </h4>
                            </td>
                            ...
                            <td class="product-subtotal">
                                <span
                                    class="price">{{ number_format($cart->variant->sale_price * $cart->variant_quantity, 2) }}
                                    VNĐ</span>
                            </td>
                            </tr>
                            @endforeach
